...
const ResetPasswordPage = () => {
    ...
    return (
        <div className="bg-[url('/Images/Home/preduction-2.png')] w-full min-h-screen bg-cover bg-center flex items-center justify-center">
            <ToastContainer />
            <form onSubmit={handleSubmit} className='w-full max-w-md border-2 border-purple-700 p-6 rounded-lg bg-white shadow-md'>
                <h2 className='text-3xl font-semibold text-[#4c1d95] mb-2'>Reset Password</h2>
                ...
                {/* New Password */}
                <div className='mb-4'>
                    <label className='font-semibold block mb-1' htmlFor="password">New Password</label>
