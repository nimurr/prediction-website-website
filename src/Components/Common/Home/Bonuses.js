    ...
    return (
        <div className='contiainer mx-auto py-10 px-4 '>
            ...
            <div className='flex items-center justify-center'>
                <Link href="/casino-reviews" className='bg-[#4c1d95] cursor-pointer hover:bg-[#3b117c] transition-colors text-white py-3 px-8 rounded-full'>
                    View All
                </Link>
            </div>
        </div>
...
// /casino-reviews/casino-reviews-details